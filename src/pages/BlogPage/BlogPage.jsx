...
function BlogPage() {
    ...
    const blogData = [
        { id: 1, name: 'Câu kỷ tử', description: "Ago sign pot cool exactly dull pilot feathers anyway art pitch earn tax throw meant those missing instrument property", image: imgDemo },
        { id: 2, name: 'Câu kỷ tử', description: "Mot cây gì đó", image: imgDemo },
        { id: 3, name: 'Câu kỷ tử', description: "la cay gi do", image: imgDemo },
        { id: 4, name: 'Câu kỷ tử', description: "la cay gi do", image: imgDemo },
    ]
